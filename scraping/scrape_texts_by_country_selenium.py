...
chrome_options.add_argument("--user-agent=university")
...
def extract_html_text(url, file_good, file_bad):
    ...
    # If error for request, write to csv and return empty dataframe
        ...
        write_error_to_csv(url, err_timeout, file_bad)
        return pd.DataFrame(), err_timeout
...
test, test_errors = extract_texts_from_urls("India")
